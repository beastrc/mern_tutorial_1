...
var fedTaxClassifications = new Schema ({
  name: {type: String},
...
fedTaxClassifications.statics.findQuery = function(obj = {}, callback) {
  this.find(obj.query || {}, obj.projection || {}).sort(obj.sortOption || {}).exec(callback);
}

module.exports = mongoose.model('fed_tax_classifications', fedTaxClassifications);
